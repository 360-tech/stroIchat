...
func GetClientLicense(l *model.License) map[string]string {
	...
	if l != nil {
		...
		props["PartnerAccounts"] = strconv.FormatBool(*l.Features.PartnerAccounts)
		props["PartnerAccountsPermissions"] = strconv.FormatBool(*l.Features.PartnerAccountsPermissions)
