...
type Client interface {
	...
	PromotePartnerToUser(ctx context.Context, userID string) (*model.Response, error)
	DemoteUserToPartner(ctx context.Context, partnerID string) (*model.Response, error)
