...
const values = {
    ...
    PROMOTE_PARTNER: 'promote_partner',
    DEMOTE_TO_PARTNER: 'demote_to_partner',
    ...
    SYSCONSOLE_READ_AUTHENTICATION_PARTNER_ACCESS: 'sysconsole_read_authentication_partner_access',
    SYSCONSOLE_WRITE_AUTHENTICATION_PARTNER_ACCESS: 'sysconsole_write_authentication_partner_access',
...
values.SYSCONSOLE_READ_PERMISSIONS = [
    ...
    values.SYSCONSOLE_READ_AUTHENTICATION_PARTNER_ACCESS,
...
values.SYSCONSOLE_WRITE_PERMISSIONS = [
    ...
    values.SYSCONSOLE_WRITE_AUTHENTICATION_PARTNER_ACCESS,
