...
export const RESOURCE_KEYS = {
    ...
    AUTHENTICATION: {
        ...
        PARTNER_ACCESS: 'authentication.partner_access',
    },
    INTEGRATIONS: {
...
export const ResourceToSysConsolePermissionsTable: Record<string, string[]> = {
    ...
    [RESOURCE_KEYS.AUTHENTICATION.PARTNER_ACCESS]: [Permissions.SYSCONSOLE_READ_AUTHENTICATION_PARTNER_ACCESS, Permissions.SYSCONSOLE_WRITE_AUTHENTICATION_PARTNER_ACCESS],
