...
export const it = {
    ...
    licensedForCloudStarter: (config: Partial<AdminConfig>, state: any, license?: ClientLicense) => Boolean(license?.IsLicensed && false && license.SkuShortName === LicenseSkus.Starter),
