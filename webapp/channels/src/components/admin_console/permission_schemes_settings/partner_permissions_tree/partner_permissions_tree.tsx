...
const PartnerPermissionsTree = ({license, onToggle, readOnly, scope, selectRow, parentRole, selected, role = {permissions: []}}: Props) => {
    const setPermissions = () => {
        const defaultPermissions = [
            ...
            {
                id: 'partner_' + Permissions.CREATE_POST,
                combined: true,
                permissions: [
    ...
    return (
        <div className='permissions-tree partner'>
...
export default PartnerPermissionsTree;
