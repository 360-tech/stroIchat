...
const messages = defineMessages({
    ...
    ssoSessionHoursDesc: {id: 'admin.service.ssoSessionHoursDesc', defaultMessage: "The number of hours from the last time a user entered their credentials to the expiry of the user's session After changing this setting, the setting will take effect after the next time the user enters their credentials."},
